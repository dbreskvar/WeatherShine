...
public class CityDatabase {
    ...
    public static final String KEY_COUNTRY_ISO = "country";

    private static final String DATABASE_NAME = "cities";
    private static final String FTS_VIRTUAL_TABLE = "FTScities";
    ...
    public Cursor getCityMatches(String query, String[] columns) {
        String selection = KEY_CITY + " MATCH ?";
    ...
    private static class DatabaseOpenHelper extends SQLiteOpenHelper {
         ...
         */
        public long addCity(String city, String state) {
