package dbug.weathershine.providers;
...
public class CitySuggestionProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "cities", SEARCH_CITY);
        matcher.addURI(AUTHORITY, "cities/#", GET_CITY);
        // to get suggestions...
    ...
    public boolean onCreate() {
        cityDatabase = new CityDatabase(getContext());
        return true;
    }
    ...
    private Cursor getSuggestions(String query) {
        ...
        String[] columns = new String[] {
                BaseColumns._ID,
                CityDatabase.KEY_CITY,
                CityDatabase.KEY_STATE,
       /* SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
                        (only if you want to refresh shortcuts) */
                SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID};

        return cityDatabase.getCityMatches(query, columns);
    }
    ...
    private Cursor getWord(Uri uri) {
        ...
        return cityDatabase.getCity(rowId, columns);
    }
